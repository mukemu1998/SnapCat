...
@(
    ...
    "## 版本定位"
    ""
    "v$version 是 SnapCat v0.2 系列的稳定整理版，重点保留 v0.2.0 之后的可见体验改进，并把源码结构整理为更适合继续迭代和回滚的状态。"
    ""
    "## 重点更新"
    ""
    ...
    "- 源码结构整理：拆分主窗口、贴图窗口、等待操作框、翻译浮窗和框选遮罩的 code-behind，降低后续改坏风险。"
    ""
    "## 使用建议"
    ""
